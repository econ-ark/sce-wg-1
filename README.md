# SCE Working Group 1: Language and Semantics

Working Group 1 of the Society for Computational Economics develops formal specifications of dynamic economic models and their solution and estimation methods. The group was formed at CEF 2026 in Venice and works with [Econ-ARK](https://econ-ark.org) and [QuantEcon](https://quantecon.org).

[Working group website](https://econ-ark.github.io/sce-wg-1/)

## Projects

- **[Project A: Semantics of Economic Models](https://econ-ark.github.io/sce-wg-1/project-a.html).** Authors write papers that develop semantic ontologies for toolkits, methods, and model classes. The papers are intended for a proposed journal special issue.
- **[Project B: Baseline Model Library](https://quantecon.github.io/community-library/).** Contributors implement and document baseline economic models, solved in several toolkits.
...
While writing, `./dev` serves a live preview of the site and rebuilds the page as you save; it skips the PDF, so run `npm run build` when you need one.
