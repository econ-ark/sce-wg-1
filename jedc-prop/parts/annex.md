...
Manufacturing's Process Specification Language ([Grüninger and Menzel 2003](#ref-gruninger2003-annex); [Bock and Grüninger 2005](#ref-bock2005)), Modelica for physical systems ([Fritzson and Engelson 1998](#ref-fritzson1998); [Modelica Association 2023](#ref-modelica2023-annex)), planning's PDDL2.1 ([Fox and Long 2003](#ref-fox2003)), and neuroscience's
NeuroML ([Gleeson et al. 2010](#ref-gleeson2010-annex)) each attach an explicit, solver-independent
...
processes ([AWS Database Blog 2026](#ref-aws2026-annex)).
...
conceptual model from a data catalog ([AWS Database Blog 2026](#ref-aws2026-annex)).
